...
- `.cursor-expert/walkthrough/scenario.md` -- The NOTIF scenario that produced the artifacts you will evaluate
- `.cursor-expert/walkthrough/routing-log.md` -- Routing decisions and tier selections
- `.cursor-expert/walkthrough/cost-summary.md` -- Cost analysis from the walkthrough
...
> **Claude Code**: Evaluation rubrics and LLM-as-a-Judge patterns are IDE-agnostic. The same rubric criteria and scoring approach work whether agents are invoked via Cursor subagents or Claude Code sequential prompting.
