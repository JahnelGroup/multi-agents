...
!!! info "Learning tier"
    This tier is for understanding concepts. No coding required. For production use, copy .cursor-practitioner/ into your project.
...
See the [Walkthrough](walkthrough.md) for a step-by-step traced scenario.
...
=== "Cursor"
    ...
    | Subagent dispatch | Via Cursor's Task tool |

=== "Claude Code"
    | What | Location |
    |------|----------|
    | Rules | `CLAUDE.md` at repo root |
    | Agents | Instructions referenced in `CLAUDE.md` |
...
See the [exercises](exercises/01-vocabulary.md) for 6 quiz-style exercises that test your understanding. These are read-the-material, answer-questions, produce-structured-outputs. No code required.
